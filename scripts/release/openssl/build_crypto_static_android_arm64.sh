#!/usr/bin/env bash
# scripts/release/openssl/build_crypto_static_android_arm64.sh
#
...
#
# Output:
#   $OTP_SRC/lib/crypto/priv/lib/aarch64-unknown-linux-android/crypto.a
#
# The release tarball script (tarball_android_arm64.sh) picks this up and
...
ARCH=aarch64-unknown-linux-android
...
CFLAGS=(
    ...
    -fno-strict-overflow -fexceptions -mbranch-protection=standard
